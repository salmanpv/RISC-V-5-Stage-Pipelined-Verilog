...
REM
REM Generated by Vivado on Sat Apr 11 16:02:08 +0530 2026
...
echo "xvlog --incr --relax -prj Pipelined_Top_vlog.prj"
call xvlog  --incr --relax -prj Pipelined_Top_vlog.prj -log xvlog.log
