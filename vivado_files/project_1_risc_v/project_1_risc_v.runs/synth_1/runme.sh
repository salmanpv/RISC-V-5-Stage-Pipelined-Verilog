...
HD_PWD='C:/Users/salmanul.pv/project_1_risc_v/project_1_risc_v.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pipelined_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Pipelined_Top.tcl
